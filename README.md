...
| 단계 | 담당 | 하는 일 | 완료 조건 |
|---|---|---|---|
| 0 시작 | 발명 마스터 선생님 | 별명·관심사를 나누고 선배를 소개받는다 | 별명 + 관심사 |
| 1 소재 발견 | 지유 선배 | 불편했던 장면을 찾고, 선배 발명을 함께 본다 | 관심 분야 + 관찰 1개 |
| 2 문제 정의 | 지유 선배 | 진짜 문제를 한 문장으로 좁힌다 | 문제 정의문 + 대상 + 불편함 |
| 3 문제해결(SCAMPER) | 지유 선배 | SCAMPER로 해결 방법을 넓힌다 | 기법 2개 + 후보 2개 |
| 4 아이디어 도출 | 지유 선배 | 하나를 골라 또렷하게 만든다 | 이름·요약·작동방식·차별점 |
| 5 발명 / 특허검색 | 특허 탐정 | KIPRIS로 비슷한 특허를 찾고 차별점을 정리한다 | 검색식 + 차별점 |

담당이 바뀔 때는 배턴터치 연출이 뜨고, **새 캐릭터가 스스로 등장 인사를 건넵니다.**
누가 어느 단계를 맡을지는 `/admin` 의 **대화구조**에서 바꿀 수 있습니다.
...
| `0-시작.md` ~ `5-발명특허검색.md` | 각 단계에서 무엇을 할지, 언제 다음으로 넘길지 |
...
②를 건너뛰고 바로 넘어가면 대화가 툭 끊깁니다. 이 순서는 `4-아이디어도출.md`
