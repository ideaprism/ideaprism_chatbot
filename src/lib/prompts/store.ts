...
const FLOW_HINTS: Record<string, string> = {
  ...
  "0-시작": "0단계 — 별명을 묻고 함께할 선배를 소개한다",
  "1-소재발견": "1단계 — 생활 속 불편함에서 발명 소재를 찾아낸다",
  "2-문제정의": "2단계 — 진짜 문제를 한 문장으로 좁힌다",
  "3-문제해결": "3단계 — SCAMPER로 해결 방법을 넓힌다",
  "4-아이디어도출": "4단계 — 후보 하나를 골라 또렷하게 만든다",
  "5-발명특허검색": "5단계 — 비슷한 특허를 찾아 차별점을 정리한다",
